...
// Wheel Factorisation OpenMp Parallel For Static Scheduling Method
void OpenMPStatic::wheelFactorizationOpenMPStatic(int n)
{
...
// Sieve Sundaram OpenMp Parallel For Static Scheduling Method
void OpenMPStatic::sundaramOpenMPStatic(int inputNumber)
{
...
void OpenMPStatic::atkinOpenMpStatic(int n)
{
	// Get the number of threads the hardware can natively support
	auto num_threads = thread::hardware_concurrency();
...
// Wheel Factorisation OpenMp Parallel For Static Scheduling Method
void OpenMPStatic::eratosthenesOpenMPStatic(int n)
{
